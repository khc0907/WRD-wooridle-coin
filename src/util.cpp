...
const char * const BITCOIN_CONF_FILENAME = "concoin.conf";
const char * const BITCOIN_PID_FILENAME = "concoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Concoin";
#else
    // Unix
