...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s concoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  concoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded concoin transaction") + "\n" +
              "  concoin-tx [options] -create [commands]   " + _("Create hex-encoded concoin transaction") + "\n" +
              "\n";
